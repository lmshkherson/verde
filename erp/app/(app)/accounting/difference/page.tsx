      ...
      <div className="grid gap-4">
        ...
        <Card title="Проводки, які є лише в одній книзі">
          ...
          <p className="mt-4 text-xs text-emerald-800/60">
            Розподіл витрат цеху на випуск зроблено пропорційно кількості випущеного за місяць,
            а на собівартість реалізації — у частці проданого. Базу розподілу варто узгодити
            з бухгалтером: за НП(С)БО 16 постійні загальновиробничі витрати розподіляються
            на базі нормальної потужності.
          </p>
        </Card>
      </div>
    </>
